...
#include "nexuiz/screenshotimage.c"
#include "nexuiz/dialog_multiplayer_screenshot.c"
#include "nexuiz/dialog_multiplayer_screenshot_screenshotviewer.c"
#include "nexuiz/screenshotlist.c"
